...
import { Heart, BookOpen, TrendingUp, Sparkles, Award } from "lucide-react";
...
export default function Layout({ children, currentPageName, onPageChange }) {
  ...
  return (
    <div className="min-h-screen relative">
      {/* Sunset overlay handled by App.css */}
      <div className="relative z-10 min-h-screen flex flex-col">
            ...
            <div className="flex items-center justify-between">
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-600 centered-text">Your authentic voice matters</p>
                </div>
              </div>
              <StreakCounter />
            </div>
                  ...
                  <li key={item.key}>
                    <button
                      ...
                      className={`flex items-center gap-6 px-8 py-6 rounded-3xl transition-all duration-300 w-full glass-effect border-0 ${
                        isActive 
                          ? "bg-gradient-to-r from-pink-100/90 via-orange-100/90 to-purple-100/90 text-pink-700 scale-110 ring-4 ring-pink-100 shadow-2xl" 
                          : "bg-white/80 text-gray-700 hover:bg-pink-50 hover:scale-105 shadow-lg hover:shadow-2xl"
                      } centered-text`}
        ...
        <div className="pb-24 md:pb-0 md:pl-64 flex-1 flex items-center justify-center min-h-[calc(100vh-80px)] centered-text">
          <main className="max-w-4xl w-full mx-auto px-4 py-8 md:py-12 centered-text">
            <div className="centered-text w-full">
              {children}
            </div>
          </main>
        </div>
